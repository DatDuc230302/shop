            ...
            <div className={cx('inner')}>
                ...
                <div className={cx('region')}>
                    <div className={cx('region-background')}>
                        <img
                            src="https://images.g2a.com/uiadminimages/1920x568/1x1x1/6cd21d8e59a4/64b9933b8e324f16823cb5b5"
                            alt=""
                        />
                        <div className={cx('region-header', tb && 'tb', mb && 'mb')}>
                            <span className={cx('region-title')}>Utilities</span>
                            <span className={cx('region-content')}>
                                View the best offers on utility software, and buy the must-have apps for both your home
                                and office.
                            </span>
                        </div>
                    </div>
                ...
                <div className={cx('security', tb && 'tb', mb && 'mb')}>
                    <div className={cx('security-background')}>
                        <img
                            src="https://firebasestorage.googleapis.com/v0/b/shop-g2a-d5524.appspot.com/o/Software-deals%2FbgSecurity.avif?alt=media&token=fd52c89b-1d33-4bbf-877f-7b4b4bc71619"
                            alt=""
                        />
                    </div>
                        ...
                        <div className={cx('security-box')}>
                            <div className={cx('security-info')}>
                                ...
                                <span className={cx('security-content')}>
                                    Check out the deals on some of the most essential security apps. Keep your data and
                                    digital privacy protected.
                                </span>
                            </div>
                            <div className={cx('security-products')}>
                                {securityProducts.map((item: any, index: number) => (
                                    <Link to={`/detail/${item.link}`} className={cx('securityProduct-img')}>
                                        <img src={item.img} alt="" />
